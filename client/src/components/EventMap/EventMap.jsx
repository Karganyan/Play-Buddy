        ...
        <div className='info'>
          {user ?
            <div className='current-info'>
              {currentEvent ?
                <>
                  <h3>{currentEvent.game && currentEvent.game.title}</h3>
                  <p>Описание события: {currentEvent.description && currentEvent.description}</p>
                  <span>Адрес: {currentEvent.address && currentEvent.address}</span>
