      ...
      <div className='container'>
        <form className='d-flex flex-column'>
          ...
          <button
            ...
            type="submit"
            className="btn btn-primary btn-sm  col-md-2 offset-md-5 mb-2"
          >
            Войти
            </button>
          <a
            href={`${process.env.REACT_APP_SERVER_URL}/user/google`}
          ...
          <a
            href={`${process.env.REACT_APP_SERVER_URL}/user/auth/vkontakte`}
